...
var formInput = document.querySelectorAll('.form .opacity-selector'); // to always prevent the page from reloading 
...
form.addEventListener('input', function () {
  var mailformat = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/; // if the field is empty make the opacity of it 0.5, if it is filled with text change the opacity to 1
